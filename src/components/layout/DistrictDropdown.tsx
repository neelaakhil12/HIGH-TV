...
export default function DistrictDropdown({ state, currentSlug, districts }: Props) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-[-85px] md:right-0 top-full mt-1 z-50 bg-white border border-gray-200 rounded-xl shadow-xl p-3 w-[450px] max-w-[calc(100vw-2rem)] md:max-w-[560px] overflow-x-auto">
