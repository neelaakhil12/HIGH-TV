...
export default function AdminPage() {
  ...
  // Mobile Ad field inputs
  const [mobileAdTitleInput, setMobileAdTitleInput] = useState('');
  ...
  const handleToggleMobileAdStatus = async (ad: any) => {
    const newStatus = ad.category === 'active' ? 'inactive' : 'active';
    try {
      const res = await fetch(`/api/articles/${ad.id}`, {
        method: 'PUT',
      ...
      console.error('Error toggling mobile ad status:', e);
    }
  };

  const handleDeleteMobileAd = async (id: string) => {
    if (!confirm('Are you sure you want to delete this mobile ad?')) return;
    try {
      ...
      if (res.ok) {
        ...
        alert('Failed to delete mobile ad.');
      }
    } catch (e) {
      console.error('Error deleting mobile ad:', e);
    }
  };

  const handleMobileAdImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    const file = e.target.files?.[0];
    if (file) {
      handleCompressAndSetImage(file, (base64) => {
        setMobileAdImageInput(base64);
      });
    }
  };

  const handleSaveMobileAd = async () => {
    if (!mobileAdTitleInput.trim()) {
      alert('Ad Title is required!');
      return;
    }
    if (!mobileAdImageInput) {
      alert('Please upload an image for the ad!');
      return;
    }

    setIsSavingMobileAd(true);
    
    const cleanSlug = mobileAdFormState === 'edit' && editingMobileAdItem 
      ? editingMobileAdItem.slug 
      : `mobile-ad-${mobileAdLocationInput.slice(-4)}-${Date.now().toString().slice(-6)}`;
    
    const adData = {
      title: mobileAdTitleInput.trim(),
      slug: cleanSlug,
      categorySlug: mobileAdLocationInput,
      category: mobileAdStatusInput,
      body: mobileAdLinkInput.trim(),
      image: mobileAdImageInput,
      author: 'హై టీవీ డెస్క్',
      isBreaking: false,
      isTrending: false,
      isFeatured: false,
    ...
    try {
      const url = mobileAdFormState === 'edit' && editingMobileAdItem ? `/api/articles/${editingMobileAdItem.id}` : '/api/articles';
      const method = mobileAdFormState === 'edit' && editingMobileAdItem ? 'PUT' : 'POST';
      ...
      if (res.ok) {
        ...
        const errorRes = await res.json();
        alert(errorRes.error || 'Failed to save mobile ad!');
      }
    } catch (err) {
      console.error('Error saving mobile ad:', err);
      alert('An error occurred while saving the ad.');
    } finally {
      setIsSavingMobileAd(false);
    }
  };
        ...
        <div className="flex-1 p-6 md:p-8 max-w-[1440px] w-full min-w-0 mx-auto">
          ...
          {activeTab === 'mobile-ads' && (() => {
            const MOBILE_AD_SLOTS = [
              ...
              { slug: 'mobile-ad-slot-6', labelTelugu: 'హోమ్: స్లాట్ 6 (ట్రెండింగ్ & పాలిటిక్స్ మధ్య - 1)', labelEnglish: 'Home: Slot 6 (Between Trending & Politics - 1)' },
              { slug: 'mobile-ad-slot-7', labelTelugu: 'హోమ్: స్లాట్ 7 (ట్రెండింగ్ & పాలిటిక్స్ మధ్య - 2)', labelEnglish: 'Home: Slot 7 (Between Trending & Politics - 2)' },
              { slug: 'mobile-ad-slot-8', labelTelugu: 'హోమ్: స్లాట్ 8 (ట్రెండింగ్ & పాలిటిక్స్ మధ్య - 3)', labelEnglish: 'Home: Slot 8 (Between Trending & Politics - 3)' },
              { slug: 'mobile-ad-slot-9', labelTelugu: 'హోమ్: స్లాట్ 9 (ట్రెండింగ్ & పాలిటిక్స్ మధ్య - 4)', labelEnglish: 'Home: Slot 9 (Between Trending & Politics - 4)' },
              ...
              // --- CATEGORY PAGES MOBILE ADS (Between Trending & Polls Section) ---
              { slug: 'mobile-ad-cat-latest', labelTelugu: 'కేటగిరీ పేజీ: బ్రేకింగ్ (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: Breaking (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-politics', labelTelugu: 'కేటగిరీ పేజీ: పాలిటిక్స్ (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: Politics (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-national', labelTelugu: 'కేటగిరీ పేజీ: నేషనల్ (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: National (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-international', labelTelugu: 'కేటగిరీ పేజీ: అంతర్జాతీయం (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: International (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-business', labelTelugu: 'కేటగిరీ పేజీ: బిజినెస్ (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: Business (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-entertainment', labelTelugu: 'కేటగిరీ పేజీ: సినిమా (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: Entertainment (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-sports', labelTelugu: 'కేటగిరీ పేజీ: స్పోర్ట్స్ (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: Sports (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-technology', labelTelugu: 'కేటగిరీ పేజీ: టెక్నాలజీ (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: Technology (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-health', labelTelugu: 'కేటగిరీ పేజీ: ఆరోగ్యం (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: Health (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-viral', labelTelugu: 'కేటగిరీ పేజీ: వైరల్ (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: Viral (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-telangana', labelTelugu: 'కేటగిరీ పేజీ: తెలంగాణ (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: Telangana (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-andhra-pradesh', labelTelugu: 'కేటగిరీ పేజీ: ఆంధ్రప్రదేశ్ (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: Andhra Pradesh (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-lifestyle', labelTelugu: 'కేటగిరీ పేజీ: లైఫ్‌స్టైల్ (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: Lifestyle (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-women', labelTelugu: 'కేటగిరీ పేజీ: మహిళా/ఆమె (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: Women (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-rasipalalu', labelTelugu: 'కేటగిరీ పేజీ: రాశిఫలాలు (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: Astrology (Between Trending & Polls)' },
              { slug: 'mobile-ad-cat-adyathmikam', labelTelugu: 'కేటగిరీ పేజీ: ఆధ్యాత్మికం (ట్రెండింగ్ & పోల్స్ మధ్య)', labelEnglish: 'Category Page: Devotional (Between Trending & Polls)' },
              ...
              { slug: 'mobile-ad-article-bottom-politics', labelTelugu: 'వ్యాసం పేజీ: పాలిటిక్స్ బాటమ్ (మరిన్ని వార్తలు & పోల్స్ మధ్య)', labelEnglish: 'Article Page: Bottom Politics (Between Read More & Polls)' },
              { slug: 'mobile-ad-article-bottom-national', labelTelugu: 'వ్యాసం పేజీ: నేషనల్ బాటమ్ (మరిన్ని వార్తలు & పోల్స్ మధ్య)', labelEnglish: 'Article Page: Bottom National (Between Read More & Polls)' },
              { slug: 'mobile-ad-article-bottom-international', labelTelugu: 'వ్యాసం పేజీ: అంతర్జాతీయం బాటమ్ (మరిన్ని వార్తలు & పోల్స్ మధ్య)', labelEnglish: 'Article Page: Bottom International (Between Read More & Polls)' },
              { slug: 'mobile-ad-article-bottom-business', labelTelugu: 'వ్యాసం పేజీ: బిజినెస్ బాటమ్ (మరిన్ని వార్తలు & పోల్స్ మధ్య)', labelEnglish: 'Article Page: Bottom Business (Between Read More & Polls)' },
              { slug: 'mobile-ad-article-bottom-entertainment', labelTelugu: 'వ్యాసం పేజీ: సినిమా బాటమ్ (మరిన్ని వార్తలు & పోల్స్ మధ్య)', labelEnglish: 'Article Page: Bottom Entertainment (Between Read More & Polls)' },
              { slug: 'mobile-ad-article-bottom-sports', labelTelugu: 'వ్యాసం పేజీ: స్పోర్ట్స్ బాటమ్ (మరిన్ని వార్తలు & పోల్స్ మధ్య)', labelEnglish: 'Article Page: Bottom Sports (Between Read More & Polls)' },
              { slug: 'mobile-ad-article-bottom-technology', labelTelugu: 'వ్యాసం పేజీ: టెక్నాలజీ బాటమ్ (మరిన్ని వార్తలు & పోల్స్ మధ్య)', labelEnglish: 'Article Page: Bottom Technology (Between Read More & Polls)' },
