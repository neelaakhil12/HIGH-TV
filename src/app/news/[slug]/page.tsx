        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
          ...
          <article className="xl:col-span-3">
            ...
            <div className="flex items-center gap-2 mb-6 flex-wrap">
              ...
              <button className="flex items-center gap-1 bg-[#1877f2] text-white text-xs font-bold px-3 py-1.5 rounded-lg hover:opacity-90 transition-opacity">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
                Facebook
              </button>
              <button className="flex items-center gap-1 bg-[#1da1f2] text-white text-xs font-bold px-3 py-1.5 rounded-lg hover:opacity-90 transition-opacity">
              ...
              <button className="flex items-center gap-1 bg-[#25d366] text-white text-xs font-bold px-3 py-1.5 rounded-lg hover:opacity-90 transition-opacity">
                <Share2 size={14} /> WhatsApp
              </button>
              <button className="flex items-center gap-1 bg-gray-100 text-gray-600 text-xs font-bold px-3 py-1.5 rounded-lg hover:bg-gray-200 transition-colors ml-auto">
            ...
            >
              <p className="text-gray-700 leading-loose text-base mb-4">
                {article.description} ఈ వార్తకు సంబంధించిన విశేషాలు క్రింద వివరించబడ్డాయి. రాష్ట్ర ప్రభుత్వం ఈ విషయంలో అధికారిక ప్రకటన విడుదల చేసింది.
              </p>
              <p className="text-gray-700 leading-loose text-base mb-4">
              ...
              <p className="text-gray-700 leading-loose text-base">
                హై టీవీ ఈ అంశాన్ని నిరంతరం ట్రాక్ చేస్తూ తాజా అప్‌డేట్‌లను అందిస్తుంది. మరిన్ని వివరాలకు మా వెబ్‌సైట్‌ను అనుసరించండి.
              </p>
            </div>
              ...
              <div className="divide-y divide-gray-50">
                {allNews.slice(0, 6).map((a) => (
                  <Link
                    key={a.id}
                    href={`/news/${a.slug}`}
                    className="flex gap-2 p-3 hover:bg-red-50 transition-colors group"
                  >
