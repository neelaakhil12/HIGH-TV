...
export const sampadakiyamNews: NewsArticle[] = [
  {
    ...
    title: 'ఎడిటోరియల్: నూతన పారిశ్రామిక విధానాలు - అభివృద్ధి పథంలో పురోగతి!',
    ...
    isFeatured: false,
    views: 15600,
    tags: ['ఎడిటోరియల్', 'పరిశ్రమలు', 'ఆقتصادం'],
  },
  {
    id: 'sd-2',
    slug: 'editorial-educational-system-reforms',
    title: 'ఎడిటోరియల్: విద్యా వ్యవస్థలో సంస్కరణలు - నాణ్యమైన విద్యే లక్ష్యంగా ముందడుగు',
    ...
    isFeatured: false,
    views: 18400,
    tags: ['ఎడిటోరియల్', 'విద్యా విధానం', 'సంస్కరణలు'],
  }
];
